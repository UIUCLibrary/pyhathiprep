...
:freeze
    ...
    call build\\msi\\pyhathiprep.exe --pytest
    endlocal
goto :eof
...
:mypy
    call:install-dev
    setlocal
    call venv\Scripts\activate.bat && mypy -p pyhathiprep %*
    endlocal
goto :eof
...
:clean
	...
	if exist pyhathiprep.egg-info rd /q /s pyhathiprep.egg-info && echo Removed pyhathiprep.egg-info
	endlocal
goto :eof
