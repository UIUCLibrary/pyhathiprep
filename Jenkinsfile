            ...
            stages{
                ...
                stage("Creating virtualenv for building"){
                    steps {
                        ...
                        bat "venv\\Scripts\\pip.exe install devpi-client lxml --upgrade-strategy only-if-needed"
...
//                                    dir("source"){
//                                        bat "dir"
//                                        bat "venv\\Scripts\\mypy.exe ${WORKSPACE}\\build\\lib\\pyhathiprep --html-report ${REPORT_DIR}\\mypy\\html"
//                                    }
//                                } catch (exc) {
...
////                        dir("source") {
////                            script{
////                                def devpi_remove_return_code = bat returnStatus: true, script: "${WORKSPACE}\\venv\\Scripts\\mypy.exe -p pyhathiprep --junit-xml=${WORKSPACE}/junit-${env.NODE_NAME}-mypy.xml --html-report ${WORKSPACE}/reports/mypy_html"
////
////                            }
////                        }
////                    }
